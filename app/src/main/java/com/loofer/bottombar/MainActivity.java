...
import com.loofer.bottombar.fragment.NavigationFragment;
import com.loofer.bottombar.fragment.RadioFragment;
import com.loofer.bottombar.fragment.TabHostFragment;
import com.loofer.bottombar.fragment.TabLayoutFragment;
import com.loofer.bottombar.fragment.TabLayoutFragment2;
import com.loofer.bottombar.fragment.TextTabFragment;
import com.loofer.bottombar.utils.SnackBarUtils;
...
//        mRadioMsg.setText("8");
    ...
    private void setNavigationViewChecked(int position) {
        ...
        Log.i("Loofer", "the count of menu item is--->" + mNavigationView.getMenu().size() + "");
...
//                Snackbar.make(mDrawerLayout, "RadioGroup", Snackbar.LENGTH_SHORT).show();
            ...
            case R.id.menu_tab_layout:
                ...
                break;
            case R.id.menu_tab_host:
                if(mTabHostFragment == null){
                    mTabHostFragment = TabHostFragment.newInstance(getString(R.string.navigation_tab_host));
                }
                transaction.replace(R.id.frame_content, mTabHostFragment);
                setNavigationViewChecked(4);
                Snackbar.make(mDrawerLayout, "TabHost", Snackbar.LENGTH_SHORT).show();
                break;
